...
class Bot:
    ...
    async def handleInlineQuery(self, update: Update, context):
        ...
        searchResults = await self.searchGames.searchGame(
            user_id, query, fallback_languages
        )

        presentation = TelegramPresenter.makeInlineQueryPresentation(
    ...
    async def set_currency(self, update: Update, context):
        ...
        countryMod = await self.userCountry.parseSetCurrencyCommand(
