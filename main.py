...
from modules.TelegramQueryMaker import TelegramInlineQueryMaker, ERROR_RESULT, TOO_SHORT_RESULT, NO_MATCHES_RESULT
...
class Bot:
    ...
    def sortGameResults(a):
        ...
        return list(filter(lambda x: x not in errors, a)) + list(filter(lambda x: x in a, errors))
